...
#### 6.8 使用.get()和.setdefault()在字典中定义默认值
...
#### 6.9 使用collections.defaultdict()处理缺少的字典键

详见: <a href="#12.2 defaultdict带有默认值的字典">12.2 defaultdict带有默认值的字典</a>

#### 6.10 使用collections.Counter计算Hashable对象
