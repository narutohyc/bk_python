...
> 所谓魔法函数（Magic Methods），是Python的一种高级语法，允许你在类中自定义函数（函数名格式一般为\_\_xx\_\_），并绑定到类的特殊方法中。比如在类A中自定义\_\_str\_\_()函数，则在调用str(A())时，会自动调用\_\_str\_\_()函数，并返回相应的结果。在我们平时的使用中，可能经常使用\_\_init\_\_函数和\_\_de\l_\_函数，其实这也是魔法函数的一种。
...
![img](res/12. python 魔法函数/11693390-6a7c5d8ff11bd930.webp)

![img](res/12. python 魔法函数/11693390-13445404dd231245.webp)
